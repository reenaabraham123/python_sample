...
input_frame = Frame(width=312, height=50, bd=0, highlightbackground="black", highlightcolor="black",
...
btns_frame = Frame(width=312, height=272.5, bg="grey")

btns_frame.pack()
#button = Button(text="Ok",width=30,height=30,command=hello)
